...
const common = {
  res: {},
  booksDir: 'D:/books',
  booksDirConfigurable: false,
  sendJson: (_res, payload) => responses.push(payload),
  setBooksDir: (dir) => ({ success: true, booksDir: dir }),
  service
}
const cases = [
  ['/api/books/dir', {}],
  ['/api/books/set-dir', { dir: 'D:/new-books' }],
  ['/api/books/list', {}],
...
assert.deepEqual(responses[1], { success: true, booksDir: 'D:/new-books' })
assert.deepEqual(responses[15], { success: true, order: 'desc' })
assert.equal(
...
assert.deepEqual(calls, [
  ...
  ['createBook', cases[3][1], 'D:/books'],
  ['editBook', cases[4][1], 'D:/books'],
  ['deleteBook', '长夜', 'D:/books'],
  ['createVolume', '长夜', 'D:/books'],
  ['createChapter', cases[7][1], 'D:/books'],
  ['loadChapters', '长夜', 'D:/books'],
  ['readChapter', cases[9][1], 'D:/books'],
  ['saveChapter', cases[10][1], 'D:/books'],
  ['checkChapterExists', cases[11][1], 'D:/books'],
  ['upsertChapter', cases[12][1], 'D:/books'],
  ['editNode', cases[13][1], 'D:/books'],
  ['deleteNode', cases[14][1], 'D:/books'],
  ['getSortOrder', '长夜'],
  ['setSortOrder', cases[16][1]],
  ['getChapterSettings', '长夜'],
  ['setChapterTargetWords', cases[18][1]],
  ['updateChapterFormat', cases[19][1], 'D:/books'],
  ['reformatChapterNumbers', cases[20][1], 'D:/books']
])
