...
油漆桶工具是地图设计工具中的重要功能之一，允许用户快速填充封闭区域。在 织梦书房 中，油漆桶工具实现了以下特性：
...
> 💡 **完整算法实现请查看**: [src/renderer/src/composables/map/tools/useBucketTool.js](https://github.com/zhimeng-shufang/zhimeng-shufang/blob/main/src/renderer/src/composables/map/tools/useBucketTool.js)
...
> 💡 **坐标转换详细实现请查看**: [src/renderer/src/composables/map/useCoordinate.js](https://github.com/zhimeng-shufang/zhimeng-shufang/blob/main/src/renderer/src/composables/map/useCoordinate.js)
...
> 💡 **完整实现代码请查看**: [src/renderer/src/composables/map/tools/useBucketTool.js](https://github.com/zhimeng-shufang/zhimeng-shufang/blob/main/src/renderer/src/composables/map/tools/useBucketTool.js)
...
> 💡 **关联逻辑请查看**: [src/renderer/src/composables/map/tools/useSelectTool.js](https://github.com/zhimeng-shufang/zhimeng-shufang/blob/main/src/renderer/src/composables/map/tools/useSelectTool.js)
...
- **油漆桶工具代码**: [src/renderer/src/composables/map/tools/useBucketTool.js](https://github.com/zhimeng-shufang/zhimeng-shufang/blob/main/src/renderer/src/composables/map/tools/useBucketTool.js)
...
- **坐标转换**: [src/renderer/src/composables/map/useCoordinate.js](https://github.com/zhimeng-shufang/zhimeng-shufang/blob/main/src/renderer/src/composables/map/useCoordinate.js)
