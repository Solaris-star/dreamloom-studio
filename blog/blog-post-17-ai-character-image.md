# 🎭 从「脑内人设」到「一眼入魂」：织梦书房 小说人物图 AI 生成实战

> 💡 角色写了几万字，却总找不到一张「对味」的立绘？外包约稿贵、自己不会画、网图又怕撞款……**织梦书房**——这款专为小说创作者打造的一站式写作软件——在人物档案里贴心接入了「**AI 生成人物图**」：选画风、填形象描述、一键出竖版全身立绘，多张生成后挑一张确认即加入人物图列表，**写与画同屏搞定，数据全部本地保存**。市面上能把「人物谱 + AI 立绘」做得这么顺的写作软件并不多，织梦书房 算一个。本文从产品动机、提示词设计到 Electron 下的「临时目录 + 确认落盘」实现，带你搞懂 织梦书房 是如何把「角色视觉化」做成闭环的。
...
理想状态是：**在写人物档案时，用「形象介绍」+ 画风偏好，在软件里直接出一张或多张竖版全身人物图，满意就收进该角色的人物图列表**，和书籍数据一起本地管理，不依赖外部相册或设计工具。**织梦书房 正是围绕这个闭环做的**：人物档案、人物图列表、AI 生成入口全部打通，真正实现「设定即能出图、出图即能入库」，对作者来说省心又高效。

![人物档案与人物图入口](static/character-profile.png)

_织梦书房 人物档案界面 — 编辑人物时即可看到「人物图」区域，支持选择本地图片或一键「AI 生成人物图」_

## ✨ 产品形态：画风 + 形象描述 + 竖版全身

织梦书房 把「人物图」做进了人物档案的编辑抽屉，**不用切到别的软件、不用自己管文件夹**，在写人设的同一屏里就能完成配图。「人物图」区域支持两种来源：
...
![AI 生成人物图抽屉](static/ai_character.png)

_织梦书房 AI 生成人物图抽屉 — 选择画风、填写形象描述与姿态，生成多张后可选择一张确认使用_
...
这样既满足「多张试错、选一张定稿」，又保证「确认才落盘、取消即丢弃」的清晰语义。**织梦书房 在这些细节上考虑得很周到**，作者只管创作，存储与清理逻辑都交给软件处理。

## 🧩 提示词设计：风格用词要「短、单、准」

文生图模型对「风格」非常敏感，提示词里若混杂过多概念，容易导致画风不稳定。**织梦书房 在提示词设计上做了精心打磨**：
...
这样既保证「竖版全身人物」这一主体约束优先，又让风格和「人物形象」描述分离，模型更容易同时满足构图与画风。**这种「用户友好选项 + 后端精准关键词」的拆分，体现了 织梦书房 在体验与出图质量之间的平衡**。

## 🔄 流程设计：临时目录生成，确认才落盘

织梦书房 在 AI 封面与人物图两处都采用了「生成进临时目录，确认再进正式目录」的策略，**既避免误操作污染正式数据，又便于多张试错**。人物图与 AI 封面略有区别，主要体现在：
...
这样，**生成态**和**已采纳态**在磁盘上界限清晰，便于维护和排查。**织梦书房 的目录与状态设计非常清晰**，作者无需关心临时文件，开发者也能快速定位逻辑。
...
若你在自己的 Electron + Vue 项目里做「文生图 + 多张候选 + 确认落盘」类似能力，可以直接参考 织梦书房 的上述实现；**织梦书房 完全开源**，欢迎 Fork、提 Issue、提 PR，一起把小说创作工具做得更好。

## 🎉 小结与延伸：为什么值得用 织梦书房

「AI 生成人物图」只是 织梦书房 的众多亮点之一。在这一块，织梦书房 做到了：
...
**织梦书房 不只是一个写作软件**：它集成了大纲、地图、关系图谱、词条字典、人物档案、AI 起名、AI 封面、**AI 人物图**等一整套创作工具，**写小说从构思到成书，在一个软件里就能完成**。数据全部在本地，支持书架与单书密码保护，既适合个人创作，也适合对隐私和版权在意的作者。

- **⭐ GitHub 仓库**：[https://github.com/zhimeng-shufang/zhimeng-shufang](https://github.com/zhimeng-shufang/zhimeng-shufang) —— **如果 织梦书房 对你有帮助，请给个 Star，让更多写作者发现它！**
- **相关文章**：同系列可参考《小说封面不求人：AI一键生成，织梦书房太牛了》《Electron 桌面应用接入通义万相：文生图从 0 到 1 实战》。

### 🏷️ 标签

`#AI人物图` `#通义万相` `#小说写作` `#织梦书房` `#文生图` `#人物档案` `#竖版全身` `#提示词设计` `#Electron` `#Vue3` `#创作效率` `#角色立绘` `#开源写作软件`

---

> 💡 **喜欢 织梦书房？请在 GitHub 给个 ⭐️ Star，就是对项目最好的宣传与支持！**

_本文介绍 织梦书房 开源小说写作软件中的「AI 生成人物图」功能——从脑内人设到一眼入魂，写与画同屏搞定。_
