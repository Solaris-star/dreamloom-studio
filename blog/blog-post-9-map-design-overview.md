...
在小说创作过程中，作者经常需要绘制故事中的地图来帮助读者理解故事背景和地理关系。传统的写作软件往往缺乏这样的可视化工具，因此我们在 织梦书房 中集成了基于 Canvas 的专业级地图设计功能。
...
> 💡 **完整代码请查看**: [src/renderer/src/views/MapDesign.vue](https://github.com/zhimeng-shufang/zhimeng-shufang/blob/main/src/renderer/src/views/MapDesign.vue)
...
> 💡 **详细实现请查看**: [src/renderer/src/composables/map/useCanvasState.js](https://github.com/zhimeng-shufang/zhimeng-shufang/blob/main/src/renderer/src/composables/map/useCanvasState.js)
...
> 💡 **详细实现请查看**: [src/renderer/src/composables/map/useElements.js](https://github.com/zhimeng-shufang/zhimeng-shufang/blob/main/src/renderer/src/composables/map/useElements.js)
...
> 💡 **详细实现请查看**: [src/renderer/src/composables/map/useHistory.js](https://github.com/zhimeng-shufang/zhimeng-shufang/blob/main/src/renderer/src/composables/map/useHistory.js)
...
> 💡 **详细实现请查看**: [src/renderer/src/composables/map/useRender.js](https://github.com/zhimeng-shufang/zhimeng-shufang/blob/main/src/renderer/src/composables/map/useRender.js)
...
> 💡 **详细实现请查看**: [src/renderer/src/composables/map/tools/usePencilTool.js](https://github.com/zhimeng-shufang/zhimeng-shufang/blob/main/src/renderer/src/composables/map/tools/usePencilTool.js)
...
> 💡 **详细实现请查看**: [src/renderer/src/composables/map/tools/useSelectTool.js](https://github.com/zhimeng-shufang/zhimeng-shufang/blob/main/src/renderer/src/composables/map/tools/useSelectTool.js)
...
> 💡 **详细实现请查看**: [src/renderer/src/composables/map/tools/useShapeTool.js](https://github.com/zhimeng-shufang/zhimeng-shufang/blob/main/src/renderer/src/composables/map/tools/useShapeTool.js)
...
> 💡 **所有工具实现请查看**: [src/renderer/src/composables/map/tools/](https://github.com/zhimeng-shufang/zhimeng-shufang/tree/main/src/renderer/src/composables/map/tools)
...
> 💡 **详细实现请查看**: [src/renderer/src/composables/map/useCoordinate.js](https://github.com/zhimeng-shufang/zhimeng-shufang/blob/main/src/renderer/src/composables/map/useCoordinate.js)
...
> 💡 **详细实现请查看**: [src/renderer/src/composables/map/useCanvas.js](https://github.com/zhimeng-shufang/zhimeng-shufang/blob/main/src/renderer/src/composables/map/useCanvas.js)
...
> 💡 **详细实现请查看**: [src/renderer/src/composables/map/tools/useResourceTool.js](https://github.com/zhimeng-shufang/zhimeng-shufang/blob/main/src/renderer/src/composables/map/tools/useResourceTool.js)
...
地图设计页是 织梦书房 项目中最复杂的功能模块之一，通过模块化的 Composables 架构设计，我们实现了：
...
- **地图设计页代码**: [src/renderer/src/views/MapDesign.vue](https://github.com/zhimeng-shufang/zhimeng-shufang/blob/main/src/renderer/src/views/MapDesign.vue)
- **Composables 目录**: [src/renderer/src/composables/map/](https://github.com/zhimeng-shufang/zhimeng-shufang/tree/main/src/renderer/src/composables/map)
