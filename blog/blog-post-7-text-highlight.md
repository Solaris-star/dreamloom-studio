...
在小说创作过程中，作者经常需要对笔记中的关键信息进行标记和分类，比如重要人物、地点、设定等。传统的文本编辑器往往只支持单一颜色的高亮，无法满足复杂的世界观管理需求。因此，我们在 织梦书房 的笔记编辑器中设计了一个多颜色文本高亮功能，让作者能够用不同颜色标记不同类型的内容。

### 🎨 高亮功能展示

![笔记编辑器](static/note-editor.png)

_多彩文本高亮功能 - 支持5种颜色标记不同类型的内容_
