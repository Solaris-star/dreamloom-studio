# 写小说也能「所见即所得」？织梦书房把正文选段变成 AI 场景图

> **写给爱写小说的你**：环境写了半页，脑子里有画面，手里却没有一张能看的图——约稿贵、自己不会画、搜图又怕版权。**织梦书房** 是面向小说作者的**开源**桌面写作软件，**官网**：[织梦书房](https://github.com/zhimeng-shufang/zhimeng-shufang)。最近在章节编辑器里上线了 **「AI 场景图」**：在正文里**划选一段**描写，点一下就能生成**与文字氛围相近**的场景插图，图片**自动保存**到本书文件夹，路径一目了然。  
...
![织梦书房 AI 场景图：编辑器选中文本 + 右侧抽屉生成场景插图](static/ai_scene.png)

_示例：选中外貌与环境描写 → 打开「AI 场景图」→ 可选 DeepSeek 提炼画面描述 → 通义万相出图 → 结果落在本书 `scene_images` 目录。_

---

## 📋 目录

- [写小说也能「所见即所得」？织梦书房把正文选段变成 AI 场景图](#写小说也能所见即所得织梦书房把正文选段变成-ai-场景图)
  - [📸 先看效果](#-先看效果)
  - [📋 目录](#-目录)
...
- 🌐 **官网**：[织梦书房](https://github.com/zhimeng-shufang/zhimeng-shufang) — 产品介绍、下载与更新说明
- ⭐ **点个 Star**：[GitHub - 织梦书房 / 织梦书房](https://github.com/zhimeng-shufang/zhimeng-shufang)
- 📥 **下载体验**：在 [Releases](https://github.com/zhimeng-shufang/zhimeng-shufang/releases) 下载对应系统安装包，配置通义万相（及可选 DeepSeek）后即可使用 AI 场景图
- 📖 **看源码**：`EditorPanel.vue`、`AISceneImageDialog.vue`、`main/index.js` 中 IPC 注册均有完整实现
- 💬 **交流反馈**：欢迎提 Issue / Discussion，好的建议会变成下一个版本的功能

**直达实现（GitHub 链接）**：

- [EditorPanel.vue - AI 场景图按钮与选区校验](https://github.com/zhimeng-shufang/zhimeng-shufang/blob/main/src/renderer/src/components/Editor/EditorPanel.vue)
- [AISceneImageDialog.vue - 抽屉与生成逻辑](https://github.com/zhimeng-shufang/zhimeng-shufang/blob/main/src/renderer/src/components/Editor/AISceneImageDialog.vue)
- [主进程 - generate-scene-image IPC](https://github.com/zhimeng-shufang/zhimeng-shufang/blob/main/src/main/index.js)
- [通义万相服务](https://github.com/zhimeng-shufang/zhimeng-shufang/blob/main/src/main/services/tongyiwanxiang.js)
- [DeepSeek 服务 - sceneVisualPromptFromExcerpt](https://github.com/zhimeng-shufang/zhimeng-shufang/blob/main/src/main/services/deepseek.js)

---

### 🏷️ 标签

`#小说写作` `#织梦书房` `#开源` `#Electron` `#Vue3` `#AI绘画` `#文生图` `#通义万相` `#DeepSeek` `#写作软件` `#创作工具`

---

> **如果这篇文章对你有帮助，欢迎访问官网 [织梦书房](https://github.com/zhimeng-shufang/zhimeng-shufang) 了解更多，并到 [GitHub 仓库](https://github.com/zhimeng-shufang/zhimeng-shufang) 给个 ⭐ Star，让更多人发现这款开源小说写作软件。**  
> 本文为基于 **织梦书房** 中「AI 场景图」功能的整理，转载请注明项目出处与开源协议。
