  ...
  >
    ...
    <div class="toolbar-buttons ai-buttons">
      <el-dropdown
        trigger="click"
        style="width: 100%;"
        @command="(cmd) => emit('trigger-ai', 'polish', cmd)"
      >
        <el-button
          class="tool-btn"
          style="width: 100%;"
        ...
        <template #dropdown>
          <el-dropdown-menu>
            ...
            <el-dropdown-item
              divided
              command="clean_selection"
            >
              AI 清理乱码 (选段)
            </el-dropdown-item>
            <el-dropdown-item command="clean_chapter">
              AI 清理乱码 (整章)
            </el-dropdown-item>
          </el-dropdown-menu>
        </template>
      ...
      <el-button
        ...
        @click="emit('trigger-ai', 'continue')"
      >
        <el-icon :size="14">
          <EditPen />
        </el-icon>
    ...
    >
      {{ t('editorToolbar.title') }}
    </div>
    <div class="toolbar-buttons">
      <el-button
        class="tool-btn"
        @click="handleOutlineManager"
      >
        <SvgIcon
          name="resource"
          :size="14"
