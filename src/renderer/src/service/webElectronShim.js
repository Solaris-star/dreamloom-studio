...
function buildElectronShim() {
  return {
    ...
    createLibraryBackup: async (payload = {}) => postJson('/api/backup/create', payload || {}),
    inspectLibraryBackup: async (payload = {}) => postJson('/api/backup/inspect', payload || {}),
    restoreLibraryBackup: async (payload = {}) => postJson('/api/backup/restore', payload || {}),
    listImportExportTasks: async () => postJson('/api/import-export/tasks', {}),
