...
export const visualStyleConfigs = {
  ...
  brutal: {
    ...
    tokens: {
      ...
      fontUi: "'Space Grotesk', Inter, 'PingFang SC', 'Microsoft YaHei', system-ui, sans-serif",
      fontDisplay: "'Space Grotesk', Inter, 'PingFang SC', system-ui, sans-serif",
      fontMono: "ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace",
      fontSizeUi: '14px',
      letterSpacing: '0.01em',
  ...
  pixel: {
    ...
    tokens: {
      ...
      fontUi: "'Press Start 2P', 'Zpix', 'PingFang SC', monospace",
      fontDisplay: "'Press Start 2P', 'Zpix', monospace",
      fontMono: "'Press Start 2P', ui-monospace, monospace",
      fontSizeUi: '11px',
      letterSpacing: '0',
      letterSpacingDisplay: '0',
      fontWeightUi: '400',
