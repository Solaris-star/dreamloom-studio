...
export function createAgentDraftConsistencyStep(checkResult = {}, title = '规则检查草稿', startedAt = Date.now()) {
...
export async function runAgentDraftConsistencyTool(input = {}, generationId = '', draft = '', source = '', title = '规则检查草稿') {
