...
const BUILTIN_WRITING_SKILLS = [
  {
    ...
    references: [
      'longform/long-chapter-hooks',
      'plot/outline-methods',
      'longform/long-format',
    ],
  ...
  },
  {
    ...
    requiredContext: ['book_meta', 'settings', 'characters', 'knowledge'],
    references: [
      'plot/plot-special-topics',
      'longform/reader-contract-and-progression',
    ],
    canWriteChapter: false,
    outputMode: 'preview',
    runner: 'editor_preview',
